...
for (samplesz in sample_size){
  ...
  legend("topleft", legend=c("Order 1","Order 2","Order 7","Order 8","Order 9","Order 10"),
       col=c("red","Black","Green","Grey","Blue","Magenta"),lty =c(1,2,7:10),cex = 0.5 )
  dev.off()
  }
  
}
  
  jpeg("RMSE VS model complexity, sample size 20.jpg")
  plot(complexity,RMSE20[1:6], pch=19, cex=0.5,
  main = paste("RMSE VS model complexity, sample 20 ", "polynomials(1,2,7,8,9,10)"),
  xlab = "Order of polynomial",ylab = "RMSE" )
  lines(complexity,RMSE20[1:6], col='red', type='l',pch=20)
  dev.off()

  jpeg("RMSE VS model complexity, sample size 100.jpg")
  plot(complexity,RMSE100[1:6], pch=19, cex=0.5,
  main = paste("RMSE VS model complexity, sample 100 ", "polynomials(1,2,7,8,9,10)"),
  xlab = "Order of polynomial",ylab = "RMSE" )
  lines(complexity,RMSE100[1:6], col='red', type='l',pch=20)
  dev.off()
  
  jpeg("RSS VS model complexity, sample size 20.jpg")
  plot(complexity,RSS20[1:6], pch=19, cex=0.5,
  main = paste("RSS VS model complexity, sample 20  ",", polynomials(1,2,7,8,9,10)"),
  xlab = "Order of polynomial",ylab = "RSS" )
  lines(complexity,RSS20[1:6], col='red', type='l',pch=20)
  dev.off()
  
  jpeg("RSS VS model complexity, sample size 100.jpg")
  plot(complexity,RSS100[1:6], pch=19, cex=0.5,
  main = paste("RSS VS model complexity, sample 100  ",", polynomials(1,2,7,8,9,10)"),
  xlab = "Order of polynomial",ylab = "RSS" )
  lines(complexity,RSS100[1:6], col='red', type='l',pch=20)
  dev.off()
